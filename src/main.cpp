...
int main() {
    ...
    HttpsServer<Nexus::IO::Win32PollMUX, CPU_CORES - 1> https(NetAddr("0.0.0.0", 443), group);
    HttpServer <Nexus::IO::Win32PollMUX, CPU_CORES - 1> http(NetAddr("0.0.0.0", 80), group);
